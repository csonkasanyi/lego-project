...
const products = [
    ...
    },
    {
        ...
        year: 2014,
        description: '',
        image: `https://www.brickguidebook.com/wp-content/uploads/2017/03/rgpYt3Us.jpg`,
        wanting: {
            wanting_id: 0,
            wanting_description: ''
        }
    ...
    },
    {
        ...
        year: 2014,
        description: '',
        image: `https://farm4.staticflickr.com/3849/15233037826_2129cfd007.jpg`,
        wanting: {
            wanting_id: 0,
            wanting_description: ''
        }
    ...
    },
    {
        ...
        year: 2004,
        description: '',
        image: `https://live.staticflickr.com/378/19404728236_44c3563ee3_b.jpg`,
        wanting: {
            wanting_id: 0,
            wanting_description: ''
        }
...
app.post('/new-lego', (req, res) => {
    const index = checkId(req.body.id);
    if (index === -1 ) {
        products.push({
            ...req.body,
        ...
        res.status(200).send('The lego creation was successfully!');
    } else {
        res.status(400).send(`The lego already exists with the given ${parseInt(req.body.id)} ID!`);
    }
});
...
app.put('/:id', (req, res) => {
    ...
    if (index !== -1) {
        ...
        res.status(404).send(`We haven't got lego with ${req.params.id} ID!`);
    }
})
