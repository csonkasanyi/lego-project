                ...
                <Grid container spacing={1}>
                    <Grid item xs={12} md={6}>
                        <Item>
                            ...
                            <Box
                                ...
                                autoComplete="off"
                            >
                                <TextField required id="outlined-basic" label="Név" variant="outlined" style={{ width: '90%' }} />
                                <TextField required id="filled-basic" label="E-mail cím" variant="outlined" style={{ width: '90%' }} />
                                <TextField required id="outlined-multiline-static" label="Üzenet" multiline rows={4} style={{ width: '90%' }} />
                            </Box>
                    ...
                    <Grid item xs={12} md={6}>
                        <Item className="contacts">
                            ...
                            <h2><a href="mailto:lego@legorenter.hu" className="link"><AlternateEmailIcon />lego@legorenter.hu</a></h2>
                            <h2><a href="tel:+47-333/78-901" className="link"><PhoneIcon />+47-333/78-901</a></h2>
